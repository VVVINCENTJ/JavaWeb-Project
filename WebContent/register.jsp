			...
			<div class="contact-form">
				...
				<div class="col-md-8 contact-grid">
					<form action="RegisterServlet" method="post">	
						...
						<input type="text" value="邮箱地址" name="email" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='邮箱地址';}">
						<input type="text" value="密码" name="password" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='密码';}">
						<input type="text" value="再次输入密码" name="password2" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='再次输入密码';}">
						
						<textarea cols="77" rows="6" value=" " name="intro" onfocus="this.value='';" onblur="if (this.value == '') {this.value = '个人介绍';}">个人介绍</textarea>
						<div class="send">
				...
				<div class="col-md-4 contact-in">
						...
						<div class="address-more">
                            <h4>状态</h4>
                            <p class="highlight">${rgtFormBean.errors.name}${DBMessage}</p>
                            <p class="highlight">${rgtFormBean.errors.password}</p>
                            <p class="highlight">${rgtFormBean.errors.password2}</p>
                            <p class="highlight">${rgtFormBean.errors.email}</p>
                        </div>
